    ...
    <div className="pb-20 pt-36" id="about">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
           ...
           */}
          <TextGenerateEffect
            words="Driving Quality and Innovation through Software Development"
          ...
          <div className="flex flex-col sm:flex-row items-center mt-10">
            <p className="text-center text-white md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
              Hi! I&apos;m <span className="text-purple">Yahya Machat</span>, a
              passionate full-stack developer. I specialize in crafting
              responsive and scalable web applications using elegant and
              efficient code.
            </p>
            <Image
              height={600}
